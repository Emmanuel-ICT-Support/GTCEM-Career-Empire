...
export async function buildAuthoredCourtyard(doors){
 ...
 root.traverse(o=>{if(!o.isMesh)return;o.castShadow=true;o.receiveShadow=true;const m=o.material;m.name=m.name.replaceAll('_',' ');m.envMap=hdr;m.envMapIntensity=.16;
  ...
  if(m.name==='ECC courtyard glass'){m.name='ECC authored glass';m.depthWrite=false;m.transparent=true;m.opacity=.26;m.side=T.DoubleSide;m.color.setHex(0xd4ded0);m.metalness=.42;m.roughness=.16;m.envMapIntensity=.65;o.castShadow=false;}
