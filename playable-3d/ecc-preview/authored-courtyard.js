...
export async function buildAuthoredCourtyard(doors){
 ...
 // Foreground planter bench retains its original path-facing direction.
 addBackedBench(root,-8.4,8.3,2.3,0);
 // Background bench remains as previously positioned.
 addBackedBench(root,-6,8.3,2.3,Math.PI/2);
 // Bench behind the avatar: back to the left, seat toward the right-hand path.
