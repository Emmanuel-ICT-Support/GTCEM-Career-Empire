...
const garden=loaded.get('garden');garden.scene.updateMatrixWorld(true);const shade=new THREE.Group();garden.scene.traverse(o=>{if(o.isMesh&&/shade/i.test(o.name)){const m=new THREE.Mesh(o.geometry,o.material);m.applyMatrix4(o.matrixWorld);
...
// The imported picnic-table model combined its seats and table under the same
// mesh names, leaving seating in garden beds.  Keep its shade only and use two
// standalone benches on the paved pads.
